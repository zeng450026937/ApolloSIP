...
const debugnict = require('debug')('SIP:NonInviteClientTransaction');
const debugict = require('debug')('SIP:InviteClientTransaction');
const debugact = require('debug')('SIP:AckClientTransaction');
const debugnist = require('debug')('SIP:NonInviteServerTransaction');
const debugist = require('debug')('SIP:InviteServerTransaction');
...
class InviteClientTransaction extends EventEmitter
{
  ...
  sendACK(response)
  {
    const ack = new SIPMessage.OutgoingRequest(SIP_C.ACK, this.request.ruri,
      this.ua, {
  ...
  cancel(reason)
  {
    ...
    const cancel = new SIPMessage.OutgoingRequest(SIP_C.CANCEL, this.request.ruri,
      this.ua, {
        'route_set' : this.request.getHeader('route'),
        'call_id'   : this.request.getHeader('call-id'),
        'cseq'      : this.request.cseq
