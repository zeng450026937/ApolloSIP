...
const debug = require('debug')('SIP:SIPMessage');
...
class OutgoingRequest
{
  ...
  toString()
  {
    ...
    const userAgent = this.ua.configuration.user_agent || SIP_C.USER_AGENT;
...
class InitialOutgoingInviteRequest extends OutgoingRequest
{
  ...
  {
    super(SIP_C.INVITE, ruri, ua, params, extraHeaders, body);
